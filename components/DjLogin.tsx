...
const DjLogin: React.FC<DjLoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-[#F2F2F2]/90 backdrop-blur-md animate-in fade-in duration-500"></div>
      
      <div className="relative w-full max-w-md bg-white rounded-[3rem] border border-neutral-200 shadow-[0_20px_60px_-15px_rgba(242,203,5,0.3)] animate-in zoom-in slide-in-from-bottom-12 duration-500 overflow-hidden">
        
        <a 
          href="#/" 
          className="absolute top-6 right-6 p-2 rounded-full hover:bg-neutral-50 transition-all text-neutral-300 hover:text-[#0D0D0D] z-10"
        >
          <X className="w-6 h-6" />
        </a>
        ...
        <div className="p-8 md:p-12">
          <header className="mb-10 flex flex-col items-center">
            ...
            <h1 className="text-3xl font-black text-[#0D0D0D] tracking-tighter uppercase italic">PANEL DJ</h1>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#F2F2F2] border border-neutral-100 rounded-[1.2rem] pl-14 pr-5 py-5 focus:outline-none focus:ring-2 focus:ring-[#F2CB05]/30 transition-all text-[#0D0D0D] placeholder:text-neutral-300 font-bold"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••"
                  className="w-full bg-[#F2F2F2] border border-neutral-100 rounded-[1.2rem] pl-14 pr-5 py-5 focus:outline-none focus:ring-2 focus:ring-[#F2CB05]/30 transition-all text-[#0D0D0D] placeholder:text-neutral-300 font-bold tracking-widest"
                />
              </div>
            </div>
          ...
          <div className="mt-10 pt-8 border-t border-neutral-50 text-center">
            <p className="text-neutral-300 text-[9px] font-black uppercase tracking-[0.4em] leading-relaxed">
